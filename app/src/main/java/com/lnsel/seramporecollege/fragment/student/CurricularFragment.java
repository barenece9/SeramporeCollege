...
public class CurricularFragment extends Fragment {
    ...
    public static CurricularFragment newInstance(int pageNo) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, pageNo);
        CurricularFragment fragment = new CurricularFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            rootView = inflater.inflate(R.layout.fragment_curricular_activity, container, false);
