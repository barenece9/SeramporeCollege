...
public class TeacherNoticeAdapter extends BaseAdapter {
    ...
    public TeacherNoticeAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            ...
            itemView = inflater.inflate(R.layout.teacher_notice_list_item, null, false);
