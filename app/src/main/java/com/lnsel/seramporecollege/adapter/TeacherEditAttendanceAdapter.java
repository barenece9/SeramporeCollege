...
public class TeacherEditAttendanceAdapter extends ArrayAdapter<Student> {
    ...
    public TeacherEditAttendanceAdapter(Activity context, List<Student> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflator.inflate(R.layout.inflate_edit_attendance_list_item, null);
