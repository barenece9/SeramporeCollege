...
public class StudentPaymentDetailsAdapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    ArrayList<HashMap<String, String>> data;
    HashMap<String, String> resultp = new HashMap<String, String>();
    public StudentPaymentDetailsAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            ...
            itemView = inflater.inflate(R.layout.student_payment_details_list_item, null, false);
        ...
        holder.subject.setText("Amount : "+resultp.get("total_amount"));
        if(resultp.get("student_payment_status").equalsIgnoreCase("1")){
            holder.student_payment_status.setText("Yes");
        }else {
            holder.student_payment_status.setText("No");
        }
        holder.received_in.setText(resultp.get("received_in"));//cash/bank

        holder.receipt_generation_date.setText(CommonMethod.dateConversion(resultp.get("receipt_generation_date")));
        holder.student_payment_date.setText("Payment Date : "+CommonMethod.dateConversion(resultp.get("student_payment_date")));
        holder.year_no.setText("Year : "+resultp.get("year_no"));
        holder.student_id.setText("Student Id : "+resultp.get("student_id"));
        holder.total_amount.setText("Total Amount(Rs) : "+resultp.get("total_amount"));
        //holder.name.setText("");
        ...
        holder.btn_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ConstantUtil.payment_collection_id=data.get(position).get("id");
                ConstantUtil.student_payment_date=data.get(position).get("student_payment_date");
                new ActivityUtil(context).startReceiptPdfViewActivity();
