...
public class TeacherDeptTimeTableAdapter extends BaseAdapter {
    Context context;
    ...
    public TeacherDeptTimeTableAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public TeacherDeptTimeTableAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            itemView = inflater.inflate(R.layout.teacher_dept_time_table_list_item, null, false);
