...
public class TeacherLeaveOBAdapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    ArrayList<HashMap<String, String>> data;
    HashMap<String, String> resultp = new HashMap<String, String>();
    public TeacherLeaveOBAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            ...
            itemView = inflater.inflate(R.layout.teacher_leave_ob_list_item, null, false);
