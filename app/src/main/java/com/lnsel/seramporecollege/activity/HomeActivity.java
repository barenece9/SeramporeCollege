...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final String TAG_PAYMENT_FEES= "paymentfees";
    private static final String TAG_NOTICE_BORD = "noticeboard";

    private static final String TAG_FACULTY_CONTACT= " facultycontact";
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Aiden Jackson");
        txtWebsite.setText("www.seramporecollege.org");
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 1:
                // photos
                StudentAttandanceFragment attandanceFragment = new StudentAttandanceFragment();
                return attandanceFragment;
            case 2:
                // movies fragment
                StudentPaymentDetailsFragment paymentStatusFragment = new StudentPaymentDetailsFragment();
                return paymentStatusFragment;
            case 3:
                // notifications fragment
                StudentPaymentDueFragment paymentFragment = new StudentPaymentDueFragment();
                return paymentFragment;

            case 4:
                // settings fragment
                StudentNoticeBordFragment noticeBordFragment = new StudentNoticeBordFragment();
                return noticeBordFragment;

            case 5:
                // settings fragment
                StudentFacultyContactFragment facultyContactFragment = new StudentFacultyContactFragment();
                return facultyContactFragment;
            default:
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_profile:
                        ...
                        CURRENT_TAG = TAG_PROFILE;
                        break;
                    case R.id.nav_attendance_status:
                        navItemIndex = 1;
                        CURRENT_TAG = TAG_ATTENDANCE;
                        break;
                    case R.id.nav_payment_status:
                        navItemIndex = 2;
                        CURRENT_TAG = TAG_PAYMENT_STATUS;
                        break;
                    case R.id.nav_payment_fees:
                        navItemIndex = 3;
                        CURRENT_TAG = TAG_PAYMENT_FEES;
                        break;
                    case R.id.nav_notice:
                        navItemIndex = 4;
                        CURRENT_TAG = TAG_NOTICE_BORD;
                        break;
                    case R.id.nav_faculty_contact:
                        navItemIndex = 5;
                        CURRENT_TAG = TAG_FACULTY_CONTACT;
                        break;
