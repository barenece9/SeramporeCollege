...
public class ApplyLeaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }else if(!InternetConnectivity.isConnectedFast(ApplyLeaveActivity.this)){
        ...
        add_btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new ActivityUtil(ApplyLeaveActivity.this).startTeacherActivity();
            }
        });
    ...
    public void getLeaveType(){
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST,
                UrlUtil.TEACHER_LEAVE_TYPE_LIST_URL,
                        ...
                        try {
                            ...
                            if(status.equals("success")){
                                ...
                                for (int i=0;i<rs.length();i++){
                                    ...
                                    leave_typeList.add(leave_type_name);
                                    leave_typeId.add(mstr_leave_type_id);
